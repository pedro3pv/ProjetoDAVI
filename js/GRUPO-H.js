...
//sequencia     0        1          2         3
let times = ["Portugal","Gana","Uruguai","Coreia do Sul"];
gols = [];
gols2 = [];
...
function calc(x, y, j, i, i2) {
    ...
    if (x != null && y != null && jogos[j] == 0) {
        ...
        for (let t = 0; t < times.length; t++) {
            ...
            document.getElementById("P" + t + "GPH").innerHTML = GP2[t]
            document.getElementById("P" + t + "GCH").innerHTML = GC2[t]
            document.getElementById("P" + t + "SGH").innerHTML = SG2[t]
        }
    }
}
}